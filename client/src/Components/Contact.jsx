      ...
      <div className="container mx-auto px-8 md:px-16 lg:px-24">
        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-12">
          <div className="flex-1">
            <h3 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-t from-green-400 to-blue-500 mb-4">Let's Talk</h3>
            <p>Collaboration starts here. Let’s connect!</p>
            <div className="mb-4 mt-8">
              <FaEnvelope className="inline-block text-green-400 mr-2" />
              <a href="mailto:Arunclenten@gmail.com" className="hover:underline">arunclenten@gmail.com</a>
            </div>
            <div className="mb-4">
          ...
          <div className="flex-1 w-full">
            <form onSubmit={handleSubmit}>
              <div>
                <label htmlFor="name" className="block mb-2 mt-5">Your Name</label>
                <input
                  type="text"
                  name="name"
                ...
                <label htmlFor="email" className="block mb-2 mt-5">Your Email</label>
                <input
                  type="text"
                  name="email"
                ...
                <label htmlFor="message" className="block mb-2 mt-5">Your Message</label>
                <textarea
                  name="message"
